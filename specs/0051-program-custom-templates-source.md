...
- **Built-ins always present.** The built-in templates (Blank, Tasks, Investigation) are always offered regardless of the directory. Built-ins carry a short description (surfaced by `construct program templates`); custom templates do not.
