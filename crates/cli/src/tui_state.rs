...
pub struct TuiState {
    ...
    #[serde(default)]
    pub open_playbook_session_ids: Vec<String>,
...
mod tests {
    ...
    #[test]
    fn legacy_state_defaults_open_playbook_ids() {
    ...
    #[test]
    fn state_round_trips_open_playbook_ids() {
        let state = TuiState {
            open_playbook_session_ids: vec!["s1".into(), "s2".into()],
            ..TuiState::default()
        };
        ...
        assert_eq!(restored.open_playbook_session_ids, vec!["s1", "s2"]);
    }
